...
public abstract class ActorAxisConstraint extends ActorTargetedConstraint {
    ...
    public static ActorAxisConstraint read(ActorArtboard artboard, StreamReader reader, ActorAxisConstraint component) {
    ...
    public boolean enableMinX() {
        return _enableMinX;
    }

    public boolean enableMinY() {
        return _enableMinY;
    }
